...
inline thread_local long long co_active_buffer[64];
...
#ifdef _WIN32
  /* ABI: Win64 */
  inline const unsigned char co_swap_function[4096] = {
...
inline cothread_t co_create(unsigned int size, void (*entrypoint)(void)) {
